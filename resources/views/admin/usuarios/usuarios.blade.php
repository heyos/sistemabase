      ...
      <div class="card-head">
        <div class="card-header">
          ...
          <div class="heading-elements">
            <button type="button" id="btnAddUser" class="btn btn-black text-white btn-sm"><i class="ft-plus white"></i> Agregar Usuario</button>
          </div>
        </div>
      </div>
...
<div id="modalUsuario" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
