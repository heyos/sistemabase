      ...
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item">
          <a class="navbar-brand" href="./">
            <img class="brand-logo" alt="modern admin logo" style="height:40px;width:auto" src="{{asset('images/empresa/empresa_955.jpg')}}">
            <h3 class="brand-text">EasyOrder</h3>
          </a>
        </li>
          ...
          <ul class="nav navbar-nav float-right">
            ...
            <li class="dropdown dropdown-notification nav-item">
              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list w-100 ps-container ps-theme-dark" data-ps-id="cd5c8860-96cf-8a52-d0d3-3d8b356cd4ff">
            ...
            <li class="dropdown dropdown-notification nav-item">
              ...
              <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                ...
                <li class="scrollable-container media-list w-100 ps-container ps-theme-dark" data-ps-id="7f26c902-3cf9-3d8e-f5a7-6fbbfd9db20f">
                  <a href="javascript:void(0)">
                    <div class="media">
                      <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="views/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"><i></i></span>
                      </div>
                      <div class="media-body">
